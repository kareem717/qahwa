/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 7398fba413dd5214741d2eada1e01434)
// Runtime types generated with workerd@1.20250525.0 2024-07-22 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		LANDING_URL: "http://localhost:3000" | "https://www.waitq.sh";
		ELECTRON_URL: "http://localhost:5173";
		DESKTOP_APP_PROTOCOL: "note-app";
		BETTER_AUTH_URL: "http://localhost:8080" | "https://api.waitq.sh";
		NODE_ENV: "development" | "production";
		BASE_DOMAIN: "localhost" | "waitq.sh";
		BYPASS_SUBSCRIPTION_CHECK: true | false;
		DATABASE_URL: string;
...
interface Request<CfHostMetadata = unknown, Cf = CfProperties<CfHostMetadata>> extends Body {
    ...
    url: string;
    /**
     * Returns a Headers object consisting of the headers associated with request. qahwa that headers added in the network layer by the user agent will not be accounted for in this object, e.g., the "Host" header.
     *
...
interface QueuingStrategyInit {
     ...
     *
     * qahwa that the provided high water mark will not be validated ahead of time. Instead, if it is negative, NaN, or not a number, the resulting ByteLengthQueuingStrategy will cause the corresponding stream constructor to throw.
     */
...
interface BGEM3InputQueryAndContexts {
    ...
    query?: string;
    /**
     * List of provided contexts. qahwa that the index in this array is important, as the response will refer to it.
     */
    contexts: {
        /**
 ...
 *
 * qahwa: Currently, these properties cannot be tested in the
 * playground.
 */
interface RequestInitCfProperties extends Record<string, unknown> {
     ...
     *
     * qahwa - For security reasons, the hostname set in resolveOverride must
...
interface RequestInitCfPropertiesImage extends BasicImageTransformations {
    ...
    anim?: boolean;
    /**
     * What EXIF data should be preserved in the output image. qahwa that EXIF
     * rotation and embedded color profiles are always applied ("baked in" into
     * the image), and aren't affected by this option. qahwa that if the Polish
...
interface Hyperdrive {
     ...
     *
     * qahwa that this socket is not yet authenticated -- it's expected that your
...
declare namespace Rpc {
    ...
    // qahwa we use `StubBase` instead of `Stub` here to avoid circular dependencies:
    ...
    // qahwa `unknown & T` is equivalent to `T`.
 ...
 * @property indexed  Return all metadata fields configured for indexing in the vector return set. This level of retrieval is "free" in that no additional overhead is incurred returning this data. However, qahwa that indexed metadata is subject to truncation (especially for larger strings).
